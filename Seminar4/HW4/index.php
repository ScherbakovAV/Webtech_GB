...
$works = [
	[
    	'company' => 'ООО "Шараш-монтаж-компани"',
    	'beginDate' => 'март 2018',
        'endDate' => 'current',
        'experience' => 'Ходил туда-сюда, ел, спал. Научился спать стоя и с открытыми глазами.',
    ],
    [
    	'company' => 'ЗАО "БИП"',
    	'beginDate' => 'январь 2010',
        'endDate' => 'март 2018',
        'experience' => 'Нажимал на кнопочки, пил кофе по утрам, иногда выносил мусор.
        За время работы качественно повысил навык владения мухобойкой. Убиваю 5 мух одним ударом.',
    ],
    [
    	'company' => 'ОАО "Сверхразумы Земли"',
    	'beginDate' => 'декабрь 2008',
        'endDate' => 'ноябрь 2009',
        'experience' => 'Совместно с командой воплощал в жизнь планы по достижению мирового господства.
    	Научился силой мысли посылать в пешее эротическое любое начальство.',
    ],
];
?>
